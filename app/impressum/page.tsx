      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-800 rounded-lg p-8 border-2 border-slate-700">
          ...
          <div className="space-y-6 text-gray-200">
            ...
            <div>
              <h2 className="text-xl font-bold text-white mb-2">Verbraucher­streit­beilegung/Universal­schlichtungs­stelle</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-white mb-2">Haftung für Links</h2>
              <p className="leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-bold text-white mb-2">Urheberrecht</h2>
              <p className="leading-relaxed">
